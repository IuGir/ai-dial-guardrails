...
def main(soft_response: bool):
    ...
    while True:
        ...
        validation = validate(ai_message.content or "")
        ...
        if validation.valid:
            ...
            filtered_ai_message = client.invoke([
                ...
                HumanMessage(content=ai_message.content or ""),
            ])
...
# Play with soft_response: True = redact PII; False = block entire response
